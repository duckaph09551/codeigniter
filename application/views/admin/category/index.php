					...
					<form action="" method="post">
						<div class="modal-body">
							<div class="form-group">
								...
								<input type="text" name="name" class="form-control " id="name" aria-describedby="name" placeholder="Ten">
							</div>
						</div>
				...
				<div class="modal-content">
					...
					<form action="" method="post">
						<div class="modal-body">
							<div class="form-group">
								<label for="exampleInputEmail1">Name <span class="text-danger font-weight-bold">(*)</span></label>
								<input type="text" name="name" class="form-control " id="nameEdit" aria-describedby="name" placeholder="Ten">
